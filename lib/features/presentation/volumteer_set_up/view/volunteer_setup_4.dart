...
import 'package:lifeline/features/presentation/volumteer_set_up/view/volunteer_setup_5.dart';
import 'package:lifeline/features/widget/custom_button.dart';
import 'package:lifeline/features/widget/page_transition.dart';

class VolunteerSetUp4 extends StatelessWidget {
  VolunteerSetUp4({super.key});
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              SpacingManager.h18,
              const UploadWidget(title: 'CPR Certificate'),
              SizedBox(
                height: MediaQuery.of(context).size.height / 2.3,
              ),
              PrimaryButton(
                onPressed: () {
                  Navigator.push(context, SizeTransition2(VolunteerSetUp5()));
                },
                buttonTitle: 'Next',
                enableButton: true,
