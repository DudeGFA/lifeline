...
import 'package:lifeline/features/presentation/volumteer_set_up/view/volunteer_setup_6.dart';
import 'package:lifeline/features/widget/custom_button.dart';
import 'package:lifeline/features/widget/page_transition.dart';

class VolunteerSetUp5 extends StatelessWidget {
  VolunteerSetUp5({super.key});
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              PrimaryButton(
                onPressed: () {
                  Navigator.push(context, SizeTransition2(VolunteerSetUp6()));
                },
                buttonTitle: 'Next',
                enableButton: true,
